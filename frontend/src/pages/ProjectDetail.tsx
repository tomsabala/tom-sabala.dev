...
function ProjectDetail() {
  ...
  if (project.is_in_progress) {
    return (
      <div className="max-w-3xl mx-auto px-4 sm:px-8 py-10">
        {backLink}
        <div className="bg-white dark:bg-[#252525] rounded-lg shadow-md border border-transparent dark:border-gray-700 p-4 sm:p-8 text-center">
          <span className="inline-block bg-amber-400 text-amber-900 text-xs font-semibold px-3 py-1 rounded-full mb-4">
            In Progress
          </span>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-3">{project.title}</h1>
          <p className="text-gray-600 dark:text-gray-400 mb-6">This project is currently in progress — stay tuned!</p>
          {project.github_url && (
            <a
