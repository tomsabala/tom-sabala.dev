        ...
        >
          ...
          >
            ...
            <div className="flex flex-col items-center gap-3">
              {inProgressItem.github_url && (
                <a
                  href={inProgressItem.github_url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-[hsl(210,65%,60%)] transition-colors"
                >
